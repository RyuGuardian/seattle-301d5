// TODOnt: Wrap the entire contents of this file in an IIFE.
...
(function(window) {
  ...
  // TODOnt: Refactor this function, so it accepts an argument of a callback function (likely a view function)
